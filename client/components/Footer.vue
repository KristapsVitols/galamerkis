            ...
            <div class="w-full mx-auto flex flex-wrap items-center">
                ...
                <div class="flex w-full content-center justify-between md:w-1/3 md:justify-end">
                    <nav class="list-reset flex justify-center flex-1 md:flex-none items-center">
                        ...
                        <a class="text-gray-200 inline-block no-underline hover:text-white hover:text-underline" href="https://www.facebook.com/Galamerkis.lv/" target="_blank" rel="noopener">
