        ...
        <div class="bg-white">
            <div class="flex flex-wrap items-center content-center">
                ...
                <div class="flex w-1/2 justify-end content-center">
                    <p class="hidden sm:block mr-3 text-center h-14 p-4 text-xs"><span class="pr-2 text-sm font-medium">Dalies</span></p>
                    <a class="inline-block text-white no-underline hover:text-white hover:underline text-center h-10 w-10 p-2 md:h-auto md:w-16 md:p-4"
                       target="_blank"
                       :href="`https://twitter.com/intent/tweet?url=https://www.galamerkis.lv/${post.category.name}/${post.slug}`" style="background-color:#33b1ff;">
                    ...
                    <a class="inline-block text-white no-underline hover:text-white hover:underline text-center h-10 w-10 p-2 md:h-auto md:w-16 md:p-4"
                       target="_blank"
                       :href="`https://www.facebook.com/sharer/sharer.php?u=https://www.galamerkis.lv/${post.category.name}/${post.slug}`" style="background-color:#005e99">
                        <svg class="fill-current text-white h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                            <path
...
export default {
    ...
    mounted() {
        this.initializeFancyProgressBar();
    },
    methods: {
        initializeFancyProgressBar() {
