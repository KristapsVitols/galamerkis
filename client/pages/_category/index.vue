...
export default {
    ...
    head() {
        return {
            ...
            meta: [
                {hid: 'description', name: 'description', content: `${this.currentCategory.description} | Galamērķis`},
                // Social sharing tags
                ...
                {hid: 'og:description', property: 'og:description', content: `${this.currentCategory.description} | Galamērķis`},
                {hid: 'og:image', name: 'og:image', content: `/content${this.currentCategory.image?.url}`},
                {hid: 'twitter:card', name: 'twitter:card', content: 'summary_large_image'},
                {hid: 'twitter:description', name: 'twitter:description', content: `${this.currentCategory.description} | Galamērķis`},
